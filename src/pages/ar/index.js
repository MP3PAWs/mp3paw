      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/ar/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/ar/" />
    ...
    <meta property="og:description"
          content="MP3 Paw هو تنزيل موسيقى MP3 مجاني بجودة عالية 320 كيلو بت في الثانية. من الشائع و Essy استخدام تنزيل MP3." />
    <link rel="canonical" href="https://mp3paw.mobi/ar/" />
