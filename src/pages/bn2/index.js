      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/bn2/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/bn2/" />
    ...
    <meta property="og:description"
          content="MP3 Paw হল বিনামূল্যে MP3 মিউজিক ডাউনলোড 320kbps উচ্চ মানের। MP3 ডাউনলোড ব্যবহার করার জন্য এটি জনপ্রিয় এবং Essy।" />
    <link rel="canonical" href="https://mp3paw.mobi/bn2/" />
