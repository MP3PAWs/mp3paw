      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/en101/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/en101/" />
    ...
    <meta property="og:description"
          content="MP3 Paw is Free MP3 Music Download in 320kbps High Quality. it's Popular and Essy to use MP3 Download." />
    <link rel="canonical" href="https://mp3paw.mobi/en101/" />
