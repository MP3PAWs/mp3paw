      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/es2/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/es2/" />
    ...
    <meta property="og:description"
          content="MP3 Paw es una descarga gratuita de música MP3 en alta calidad de 320 kbps. es Popular y Essy usar MP3 Download." />
    <link rel="canonical" href="https://mp3paw.mobi/es2/" />
