      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/hi2/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/hi2/" />
    ...
    <meta property="og:description"
          content="MP3 Paw 320kbps उच्च गुणवत्ता में मुफ्त एमपी3 संगीत डाउनलोड है। एमपी3 डाउनलोड का उपयोग करना लोकप्रिय और आसान है।" />
    <link rel="canonical" href="https://mp3paw.mobi/hi2/" />
