    ...
    <>
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/id2/" className="text-white text-[32px] inline-flex items-center"
      ...
      <section className="p-5">
        <div className="mx-auto max-w-[550px]">
          ...
          <h1 className="mt-6" title="MP3 PAW - Download Free MP3 Music">MP3 PAW - Unduh Musik MP3 Gratis</h1>
          <p>
            MP3 Kaki adalah alat mesin pencari MP3 yang memungkinkan Anda mencari dan mengunduh musik MP3 gratis dengan
            kualitas tinggi. Situs web ini kompatibel dengan semua jenis perangkat, seperti komputer, tablet, dan
            smartphone. Interferensi yang sederhana dan ramah pengguna menjadikan Mp3paw sebagai pengunduh MP3 yang
            populer.
          </p>
          <p>
            Anda dapat mendownload Mp3 dengan cepat, mudah, dan Gratis dengan beberapa klik saja. Cukup ketik kueri
            musik yang ingin Anda unduh dan klik tombol Unduh. Pengunduhan dimulai dalam beberapa detik.
          </p>
          <h2 className="mt-2 pb-2" title="How to use an MP3 paw?">Bagaimana cara menggunakan paw MP3?</h2>
          <ol className="m-0 pl-4 list-decimal text-justify">
            <li className="p-0 pb-2">Masukkan kata kunci atau nama musik ke dalam kotak pencarian.</li>
            <li className="p-0 pb-2">Klik tombol cari dan tunggu hingga daftar hasil muncul.</li>
            <li className="p-0">Tekan tombol "Unduh" yang ingin Anda unduh.</li>
          </ol>
          <h2 className="mt-5 pb-2" title="Mp3Paw Features">Fitur Mp3Paw</h2>
          <ol className="m-0 pl-4 list-disc text-justify">
            <li className="p-0 pb-2">Konversi dan unduhan berkecepatan tinggi.</li>
            <li className="p-0 pb-2">100% aman dan terjamin.</li>
            <li className="p-0 pb-2">Sepenuhnya kompatibel dengan semua browser dan perangkat.</li>
            <li className="p-0 pb-2">Tidak perlu menginstal aplikasi atau perangkat lunak.</li>
            <li className="p-0 pb-2">Unduh MP3 sepenuhnya gratis tanpa batasan.</li>
          </ol>
        </div>
      </section>
...
export const Head = () => (
  <>
    <html lang="id" />
    <title>MP3 PAW - Unduh Musik MP3 Gratis dalam Kualitas Tinggi</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="robots" content="index,follow" />
    <meta name="description"
          content="MP3 Paw adalah Unduhan Musik MP3 Gratis dalam Kualitas Tinggi 320kbps. Populer dan Essy untuk menggunakan Unduhan MP3." />
    <meta name="keywords"
    ...
    <meta property="og:url" content="https://mp3paw.mobi/id2/" />
    <meta property="og:title" content="MP3 PAW - Unduh Musik MP3 Gratis dalam Kualitas Tinggi" />
    <meta property="og:image" content="https://mp3paw.mobi/icons/icon-72x72.png" />
    <meta property="og:description"
          content="MP3 Paw adalah Unduhan Musik MP3 Gratis dalam Kualitas Tinggi 320kbps. Populer dan Essy untuk menggunakan Unduhan MP3." />
    <link rel="canonical" href="https://mp3paw.mobi/id2/" />
