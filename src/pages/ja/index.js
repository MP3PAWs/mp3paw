      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/ja/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/ja/" />
    ...
    <meta property="og:description"
          content="MP3 Paw は、320kbps 高品質の無料 MP3 音楽ダウンロードです。 MP3 ダウンロードを使用するのは人気があり、非常に便利です。" />
    <link rel="canonical" href="https://mp3paw.mobi/ja/" />
