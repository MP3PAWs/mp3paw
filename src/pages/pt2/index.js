    ...
    <>
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/pt2/" className="text-white text-[32px] inline-flex items-center"
      ...
      <section className="p-5">
        <div className="mx-auto max-w-[550px]">
          ...
          <h1 className="mt-6" title="MP3 PAW - Download Free MP3 Music">MP3 PAW - Baixe músicas em MP3 grátis</h1>
          <p>
            Pata MP3 é uma ferramenta de mecanismo de pesquisa de MP3 que permite pesquisar e baixar músicas MP3
            gratuitas em alta qualidade. Este site é compatível com todos os tipos de dispositivos, como computadores,
            tablets e smartphones. A interferência simples e fácil de usar torna o Mp3paw um popular downloader de MP3.
          </p>
          <p>
            Você pode baixar MP3 de forma rápida, fácil e gratuita com apenas alguns cliques. Basta digitar uma consulta
            de música que deseja baixar e clicar no botão Download. Os downloads começam em alguns segundos.
          </p>
          <h2 className="mt-2 pb-2" title="How to use an MP3 paw?">Como usar uma pata MP3?</h2>
          <ol className="m-0 pl-4 list-decimal text-justify">
            <li className="p-0 pb-2">Digite uma palavra-chave ou nome de música na caixa de pesquisa.</li>
            <li className="p-0 pb-2">Clique no botão de pesquisa e aguarde até que a lista de resultados apareça.</li>
            <li className="p-0">Pressione o botão "Download" que você deseja baixar.</li>
          </ol>
          <h2 className="mt-5 pb-2" title="Mp3Paw Features">Recursos do MP3Paw</h2>
          <ol className="m-0 pl-4 list-disc text-justify">
            <li className="p-0 pb-2">Conversão e download em alta velocidade.</li>
            <li className="p-0 pb-2">100% seguro e seguro.</li>
            <li className="p-0 pb-2">Totalmente compatível com todos os navegadores e dispositivos.</li>
            <li className="p-0 pb-2">Não há necessidade de instalar aplicativos ou software.</li>
            <li className="p-0 pb-2">Baixe MP3 totalmente grátis sem limitação.</li>
          </ol>
        </div>
      </section>
...
export const Head = () => (
  <>
    <html lang="pt" />
    <title>MP3 PAW - Baixe músicas em MP3 grátis em alta qualidade</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="robots" content="index,follow" />
    <meta name="description"
          content="MP3 Paw é um download gratuito de música MP3 em alta qualidade de 320kbps. é popular e Essy usar o download de MP3." />
    <meta name="keywords"
    ...
    <meta property="og:url" content="https://mp3paw.mobi/pt2/" />
    <meta property="og:title" content="MP3 PAW - Baixe músicas em MP3 grátis em alta qualidade" />
    <meta property="og:image" content="https://mp3paw.mobi/icons/icon-72x72.png" />
    <meta property="og:description"
          content="MP3 Paw é um download gratuito de música MP3 em alta qualidade de 320kbps. é popular e Essy usar o download de MP3." />
    <link rel="canonical" href="https://mp3paw.mobi/pt2/" />
