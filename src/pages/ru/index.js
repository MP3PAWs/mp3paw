      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/ru/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/ru/" />
    ...
    <meta property="og:description"
          content="MP3 Paw - бесплатная загрузка музыки в формате MP3 в высоком качестве со скоростью 320 кбит/с. это популярно и сложно использовать загрузку MP3." />
    <link rel="canonical" href="https://mp3paw.mobi/ru/" />
