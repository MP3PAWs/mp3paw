      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/th/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/th/" />
    ...
    <meta property="og:description"
          content="MP3 Paw ดาวน์โหลดเพลง MP3 ฟรีในคุณภาพสูง 320kbps เป็นที่นิยมและใช้ง่ายในการดาวน์โหลด MP3" />
    <link rel="canonical" href="https://mp3paw.mobi/th/" />
