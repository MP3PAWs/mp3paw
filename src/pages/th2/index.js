    ...
    <>
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/th2/" className="text-white text-[32px] inline-flex items-center"
      ...
      <section className="p-5">
        <div className="mx-auto max-w-[550px]">
          ...
          <h1 className="mt-6" title="MP3 PAW - Download Free MP3 Music">MP3 PAW - ดาวน์โหลดเพลง MP3 ฟรี</h1>
          <p>
            ตีน MP3 เป็นเครื่องมือค้นหา MP3 ที่ช่วยให้คุณสามารถค้นหาและดาวน์โหลดเพลง MP3 ฟรีคุณภาพสูง
            เว็บไซต์นี้ใช้งานได้กับอุปกรณ์ทุกประเภท เช่น คอมพิวเตอร์ แท็บเล็ต และสมาร์ทโฟน
            การรบกวนที่เรียบง่ายและเป็นมิตรกับผู้ใช้ทำให้ Mp3paw เป็นเครื่องมือดาวน์โหลด MP3 ยอดนิยม
          </p>
          <p>
            คุณสามารถดาวน์โหลด Mp3 ได้อย่างรวดเร็ว ง่ายดาย และฟรีด้วยการคลิกเพียงไม่กี่ครั้ง
            เพียงพิมพ์คำถามเกี่ยวกับเพลงที่คุณต้องการดาวน์โหลดแล้วคลิกที่ปุ่มดาวน์โหลด
            การดาวน์โหลดจะเริ่มขึ้นภายในไม่กี่วินาที
          </p>
          <h2 className="mt-2 pb-2" title="How to use an MP3 paw?">จะใช้ตีน MP3 ได้อย่างไร?</h2>
          <ol className="m-0 pl-4 list-decimal text-justify">
            <li className="p-0 pb-2">ป้อนคำหลักหรือชื่อเพลงในช่องค้นหา</li>
            <li className="p-0 pb-2">คลิกปุ่มค้นหาและรอจนกระทั่งรายการผลลัพธ์ปรากฏขึ้น</li>
            <li className="p-0">กดปุ่ม “ดาวน์โหลด” ที่คุณต้องการดาวน์โหลด</li>
          </ol>
          <h2 className="mt-5 pb-2" title="Mp3Paw Features">คุณสมบัติ Mp3Paw</h2>
          <ol className="m-0 pl-4 list-disc text-justify">
            <li className="p-0 pb-2">การแปลงและดาวน์โหลดความเร็วสูง</li>
            <li className="p-0 pb-2">ปลอดภัย 100%</li>
            <li className="p-0 pb-2">เข้ากันได้อย่างสมบูรณ์กับเบราว์เซอร์และอุปกรณ์ทั้งหมด</li>
            <li className="p-0 pb-2">ไม่จำเป็นต้องติดตั้งแอพหรือซอฟต์แวร์</li>
            <li className="p-0 pb-2">ดาวน์โหลด MP3 ฟรีโดยไม่มีข้อจำกัด</li>
          </ol>
        </div>
      </section>
...
export const Head = () => (
  <>
    <html lang="th" />
    <title>MP3 PAW - ดาวน์โหลดเพลง MP3 ฟรีในคุณภาพสูง</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="robots" content="index,follow" />
    <meta name="description"
          content="MP3 Paw ดาวน์โหลดเพลง MP3 ฟรีในคุณภาพสูง 320kbps เป็นที่นิยมและใช้ง่ายในการดาวน์โหลด MP3" />
    <meta name="keywords"
    ...
    <meta property="og:url" content="https://mp3paw.mobi/th2/" />
    <meta property="og:title" content="MP3 PAW - ดาวน์โหลดเพลง MP3 ฟรีในคุณภาพสูง" />
    <meta property="og:image" content="https://mp3paw.mobi/icons/icon-72x72.png" />
    <meta property="og:description"
          content="MP3 Paw ดาวน์โหลดเพลง MP3 ฟรีในคุณภาพสูง 320kbps เป็นที่นิยมและใช้ง่ายในการดาวน์โหลด MP3" />
    <link rel="canonical" href="https://mp3paw.mobi/th2/" />
