    ...
    <>
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/tl-ph2/" className="text-white text-[32px] inline-flex items-center"
      ...
      <section className="p-5">
        <div className="mx-auto max-w-[550px]">
          ...
          <h1 className="mt-6" title="MP3 PAW - Download Free MP3 Music">MP3 PAW - Mag-download ng Libreng MP3
            Music</h1>
          <p>
            MP3 Paw ay isang MP3 search engine tool na nagbibigay-daan sa iyong maghanap at mag-download ng libreng MP3
            na musika sa mataas na kalidad. Ang website na ito ay tugma sa lahat ng uri ng device, gaya ng mga computer,
            tablet, at smartphone. Ang simple at user-friendly na interference ay ginagawang sikat na MP3 downloader ang
            Mp3paw.
          </p>
          <p>
            Maaari mong i-download ang Mp3 nang mabilis, madali, at Libre sa ilang mga pag-click. Mag-type lamang ng
            query ng musika na gusto mong i-download at mag-click sa button na I-download. Magsisimula ang mga
            pag-download sa loob ng ilang segundo.
          </p>
          <h2 className="mt-2 pb-2" title="How to use an MP3 paw?">Paano gumamit ng MP3 paw?</h2>
          <ol className="m-0 pl-4 list-decimal text-justify">
            <li className="p-0 pb-2">Maglagay ng keyword o pangalan ng musika sa box para sa paghahanap.</li>
            <li className="p-0 pb-2">I-click ang search button at maghintay hanggang lumitaw ang listahan ng mga
              resulta.
            </li>
            <li className="p-0">Pindutin ang pindutang "I-download" na gusto mong i-download.</li>
          </ol>
          <h2 className="mt-5 pb-2" title="Mp3Paw Features">Mga Tampok ng Mp3Paw</h2>
          <ol className="m-0 pl-4 list-disc text-justify">
            <li className="p-0 pb-2">Mataas na bilis ng conversion at pag-download.</li>
            <li className="p-0 pb-2">100% ligtas at ligtas.</li>
            <li className="p-0 pb-2">Ganap na katugma sa lahat ng mga browser at device.</li>
            <li className="p-0 pb-2">Hindi na kailangang mag-install ng mga app o software.</li>
            <li className="p-0 pb-2">I-download ang MP3 nang libre nang walang limitasyon.</li>
          </ol>
        </div>
      </section>
...
export const Head = () => (
  <>
    <html lang="tl-ph" />
    <title>MP3 PAW - Mag-download ng MP3 Music na Libre sa Mataas na Kalidad</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="robots" content="index,follow" />
    <meta name="description"
          content="Ang MP3 Paw ay Libreng MP3 Music Download sa 320kbps High Quality. ito ay Sikat at Essy na gumamit ng MP3 Download." />
    <meta name="keywords"
    ...
    <meta property="og:url" content="https://mp3paw.mobi/tl-ph2/" />
    <meta property="og:title" content="MP3 PAW - Mag-download ng MP3 Music na Libre sa Mataas na Kalidad" />
    <meta property="og:image" content="https://mp3paw.mobi/icons/icon-72x72.png" />
    <meta property="og:description"
          content="Ang MP3 Paw ay Libreng MP3 Music Download sa 320kbps High Quality. ito ay Sikat at Essy na gumamit ng MP3 Download." />
    <link rel="canonical" href="https://mp3paw.mobi/tl-ph2/" />
