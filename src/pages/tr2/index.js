    ...
    <>
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/tr2/" className="text-white text-[32px] inline-flex items-center"
      ...
      <section className="p-5">
        <div className="mx-auto max-w-[550px]">
          ...
          <h1 className="mt-6" title="MP3 PAW - Download Free MP3 Music">MP3 PAW - Ücretsiz MP3 Müzik İndir</h1>
          <p>
            MP3 Pati yüksek kalitede ücretsiz MP3 müzik aramanıza ve indirmenize izin veren bir MP3 arama motoru
            aracıdır. Bu web sitesi, bilgisayarlar, tabletler ve akıllı telefonlar gibi her tür cihazla uyumludur. Basit
            ve kullanıcı dostu müdahale, Mp3paw'ı popüler bir MP3 indiricisi yapar.
          </p>
          <p>
            Birkaç tıklama ile hızlı, kolay ve Ücretsiz olarak Mp3 indirebilirsiniz. İndirmek istediğiniz müzik
            sorgusunu yazmanız ve İndir düğmesine tıklamanız yeterlidir. İndirmeler birkaç saniye içinde başlar.
          </p>
          <h2 className="mt-2 pb-2" title="How to use an MP3 paw?">MP3 pençesi nasıl kullanılır?</h2>
          <ol className="m-0 pl-4 list-decimal text-justify">
            <li className="p-0 pb-2">Arama kutusuna bir anahtar kelime veya müzik adı girin.</li>
            <li className="p-0 pb-2">Arama düğmesine tıklayın ve sonuç listesi görünene kadar bekleyin.</li>
            <li className="p-0">İndirmek istediğiniz “İndir” düğmesine basın.</li>
          </ol>
          <h2 className="mt-5 pb-2" title="Mp3Paw Features">Mp3Paw Özellikleri</h2>
          <ol className="m-0 pl-4 list-disc text-justify">
            <li className="p-0 pb-2">Yüksek hızlı dönüştürme ve indirme.</li>
            <li className="p-0 pb-2">%100 güvenli ve güvenli.</li>
            <li className="p-0 pb-2">Tüm tarayıcılar ve cihazlarla tam uyumludur.</li>
            <li className="p-0 pb-2">Uygulama veya yazılım yüklemeye gerek yoktur.</li>
            <li className="p-0 pb-2">Sınırlama olmaksızın tamamen ücretsiz MP3 indirin.</li>
          </ol>
        </div>
      </section>
...
export const Head = () => (
  <>
    ...
    <meta name="description"
          content="MP3 Paw, 320kbps Yüksek Kalitede Ücretsiz MP3 Müzik İndirmesidir. MP3 İndirmeyi kullanmak Popüler ve Essy'dir." />
    <meta name="keywords"
    ...
    <meta property="og:url" content="https://mp3paw.mobi/tr2/" />
    ...
    <meta property="og:description"
          content="MP3 Paw, 320kbps Yüksek Kalitede Ücretsiz MP3 Müzik İndirmesidir. MP3 İndirmeyi kullanmak Popüler ve Essy'dir." />
    <link rel="canonical" href="https://mp3paw.mobi/tr2/" />
