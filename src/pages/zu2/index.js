      ...
      <header className="p-5 bg-primary border border-[#5d2e0d]">
        <div className="mx-auto max-w-[550px]">
          <div className="mb-2.5 text-center">
            <Link to="/zu2/" className="text-white text-[32px] inline-flex items-center"
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://mp3paw.mobi/zu2/" />
    ...
    <meta property="og:description"
          content="I-MP3 Paw imahhala MP3 Landa Umculo ngekhwalithi ephezulu engu-320kbps. Kuyadumile futhi Essy ukusebenzisa MP3 Download." />
    <link rel="canonical" href="https://mp3paw.mobi/zu2/" />
